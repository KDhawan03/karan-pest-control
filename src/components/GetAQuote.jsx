...
export default function GetAQuote() {
    ...
    // const imageSrc = "https://images.unsplash.com/photo-1506744038136-46273834b3fb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cGVzdCUyMGNvbnRyb2x8ZW58MHx8MHx8fDA%3D&w=1000&q=80";
            ...
            <div className="mx-auto max-w-7xl px-6">
                <div className="rounded-2xl bg-emerald-50 overflow-hidden shadow-lg grid grid-cols-1 lg:grid-cols-2">
                            ...
                            <div className="space-y-5">
                                ...
                                <div>
                                    <input
                                        ...
                                        className={`w-full rounded-xl border border-gray-200 px-5 py-6 text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-200 ${errors.service ? "border-red-500" : ""
                                            }`}
                                    />
                    ...
                    <div className="hidden lg:block">
                        <img src={imageSrc} alt="quote" className="h-full w-full object-cover rounded-tr-2xl rounded-br-2xl" />
                    </div>
                </div>
            </div>
        </section>
