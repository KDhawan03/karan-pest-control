        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 text-center lg:text-left">
            ...
            <p className="text-sm">
              ...
              <a href="tel:+917355169038" className="hover:text-[#299B46]">
                +91 7355169038
              </a>
            </p>
          ...
          {/* MOBILE: PEST + ABOUT SAME SECTION */}
          <div className="grid grid-cols-2 gap-6 lg:contents ">
            ...
            <div>
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-2.5 text-sm text-center lg:text-left">
                {servicesData.map((service, index) => (
                  <li
                    key={service.id}
                    className={`${index > 3 ? "hidden md:list-item" : ""} whitespace-nowrap`}
                  >
                    <Link
                      to={`/services/${service.id}`}
                      className="cursor-pointer transition-colors hover:text-[#1e1a3d]"
                    >
                      {service.name}
                    </Link>
                  </li>
            ...
            <div className="lg:ml-20">
              ...
              <ul className="space-y-2 text-sm text-center lg:text-left">
                <li><a href="#reviews" className="hover:text-[#1e1a3d]">Reviews</a></li>
                <li><a href="#services" className="hover:text-[#1e1a3d]">Our Services</a></li>
                <li><a href="#faq" className="hover:text-[#1e1a3d]">FAQ</a></li>
                <li><a href="#about" className="hover:text-[#1e1a3d]">About Us</a></li>
              </ul>
            </div>
          </div>
